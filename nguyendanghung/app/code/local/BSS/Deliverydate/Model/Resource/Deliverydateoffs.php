 ...
 */
class BSS_Deliverydate_Model_Resource_Deliverydateoffs extends Mage_Core_Model_Resource_Db_Abstract
{
    public function _construct()
    {    
        // Note that the deliverydate_id refers to the key field in your database table.
        $this->_init('deliverydate/deliverydateoffs', 'dateoffs_id');
    }
}