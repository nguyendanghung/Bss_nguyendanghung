...
$this->_conn->addColumn($this->getTable('sales_flat_quote'), 'shipping_arrival_timeslot', 'text');
$this->_conn->addColumn($this->getTable('sales_flat_order'), 'shipping_arrival_timeslot', 'text');
